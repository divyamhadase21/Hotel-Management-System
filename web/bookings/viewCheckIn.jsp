...
<head>
    ...
    <style>
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .badge { padding:4px 12px; border-radius:20px; font-size:12px; font-weight:600; background:rgba(76,175,80,0.2); color:#81c784; border:1px solid rgba(76,175,80,0.3); }
...
<body>
   ...
   Connection con = DriverManager.getConnection(
    "jdbc:mysql://localhost:3306/hoteldb", "root", "root");
                    ...
                    ResultSet rs = st.executeQuery("SELECT * FROM check_in ORDER BY created_at DESC");
                    int i = 1;
            ...
            <%
                    ...
                    if(!hasData) {
            %>
                <tr><td colspan="8" class="no-data">No check-in records found.</td></tr>
            <%
                    }
                    con.close();
                } catch(Exception e) {
