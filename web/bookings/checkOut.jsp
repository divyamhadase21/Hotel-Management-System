...
<html>
<head>
    <title>Check Out — Luxury Stay</title>
    ...
    <style>
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        input { width:100%; padding:11px 16px; border-radius:10px; border:1px solid var(--glass-border); background:rgba(255,255,255,0.07); color:var(--text-primary); font-size:14px; font-family:'Inter',sans-serif; outline:none; transition:border-color .2s; }
    ...
    <div class="container">
        <div class="card">
            ...
            <form action="../CheckOutServlet" method="post">
                ...
                <button type="submit" class="submit-btn">Confirm Check Out</button>
            </form>
        </div>
    </div>
</body>
